...
ActiveRecord::Schema.define(version: 2020_01_12_113339) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "bullet_elo", default: 1000, null: false
    t.integer "blitz_elo", default: 1000, null: false
    t.integer "classical_elo", default: 1000, null: false
    t.integer "rapid_elo", default: 1000, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
